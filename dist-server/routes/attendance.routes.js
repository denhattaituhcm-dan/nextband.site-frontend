...
const attendanceRoutes = async (fastify) => {
    ...
    fastify.get('/classes/:classId/sessions/:sessionId/attendance', { preHandler: [authenticate] }, async (request, reply) => {
    ...
    fastify.post('/classes/:classId/sessions/:sessionId/attendance', { preHandler: [authenticate, requireRoles('admin', 'teacher')] }, async (request, reply) => {
        const user = request.user;
        const { classId, sessionId } = request.params;
        const body = markAttendanceSchema.parse(request.body);
        try {
            const result = await attendanceService.markSessionAttendance(classId, sessionId, user.id, user.roles || [], body.items);
    ...
    fastify.post('/classes/:classId/sessions/:sessionId/complete', { preHandler: [authenticate, requireRoles('admin', 'teacher')] }, async (request, reply) => {
        const user = request.user;
        const { classId, sessionId } = request.params;
        try {
            const result = await attendanceService.completeSession(classId, sessionId, user.id, user.roles || []);
    ...
    fastify.get('/classes/:classId/attendance-matrix', { preHandler: [authenticate] }, async (request, reply) => {
        const user = request.user;
    ...
    fastify.get('/classes/:classId/sessions', { preHandler: [authenticate] }, async (request, reply) => {
        const { classId } = request.params;
    ...
    fastify.post('/classes/:classId/sessions/:sessionId/unlock', { preHandler: [authenticate, requireRoles('admin', 'teacher')] }, async (request, reply) => {
        const user = request.user;
        const { classId, sessionId } = request.params;
        try {
    ...
    fastify.post('/classes/:classId/sessions/generate', { preHandler: [authenticate, requireRoles('admin', 'teacher')] }, async (request, reply) => {
        const user = request.user;
        const { classId } = request.params;

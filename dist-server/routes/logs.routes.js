...
const logsRoutes = async (fastify) => {
    ...
    fastify.get("/log-viewer", { preHandler: [authenticate, requireRoles("admin")] }, async (request, reply) => {
    ...
    fastify.get("/log-viewer/last", { preHandler: [authenticate, requireRoles("admin")] }, async (request, reply) => {

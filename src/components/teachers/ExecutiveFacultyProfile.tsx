...
export function ExecutiveFacultyProfile({
  ...
  return (
    <div
      className={cn(
        "rounded-3xl border border-border/80 bg-card p-6 sm:p-8 lg:p-10 space-y-8 sm:space-y-10 shadow-xs max-w-5xl mx-auto",
        className
      )}
    >
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* LAYER 4: PROVE IT (Original TRF Document Verification Frame)              */}
      {/* ========================================================================= */}
      {teacher.certificate && (

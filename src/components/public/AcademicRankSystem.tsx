...
export const ACADEMIC_RANKS: AcademicRank[] = [
  ...
  },
  {
    ...
    bandPlaceholder: "Năng lực tư duy học thuật nâng cao (IELTS 7.0 – 8.0)",
    description: "Sử dụng ngôn ngữ tự nhiên, linh hoạt và chuẩn xác. Kiểm soát tính mạch lạc và lựa chọn từ vựng nhất quán trong các ngữ cảnh học thuật.",
    competencyPillars: ["Từ vựng học thuật & Collocation chuẩn", "Bố cục logic mạch lạc", "Phản xạ tự nhiên theo chủ đề", "Xử lý sắc thái ngữ nghĩa tinh tế"],
    theme: {
      name: "Crimson Ruby",
  ...
  },
  {
    ...
    bandPlaceholder: "Thuần thục ngôn ngữ & Học thuật (IELTS 8.0 – 8.5)",
    description: "Đạt đến độ thuần thục cao. Năng lực học thuật toàn diện, khả năng phân tích logic và diễn đạt uyển chuyển.",
    competencyPillars: ["Đọc hiểu & Nghe hiểu chuyên sâu", "Văn phong học thuật chuẩn mực", "Kiểm soát độ chính xác và sắc thái", "Tư duy phản biện sắc sảo"],
    theme: {
      name: "Royal Sapphire",
